...
const AddMovie = () => {
    ...
    const createActor = async () => {
        try {
            ...
            setNewActor({ name: '', birthdate: '', nationality: '', bio: '', awards: [{ title: '', year: '' }] });
    ...
    const createDirector = async () => {
        try {
            ...
            setNewDirector({ name: '', birthdate: '', nationality: '', bio: '', awards: [{ title: '', year: '' }] });
    ...
    return (
        <form className="container add-movie-form my-5" onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className="new-instance">
                        ...
                        <label className="label">
                            <input
                                ...
                                placeholder="nationality"
                                onChange={(e) => setNewDirector({ ...newDirector, nationality: e.target.value })}
                            />
                        </label>
                    </div>
                    <label className="label">
            ...
            <button className="update-button" type="submit">Create Movie</button>
        </form>
    );
};
